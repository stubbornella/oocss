...
<li><h4>Separate structure and skin</h4>
    <p>In plain terms, this means: use classes to name your objects and their components. For example, the media object is named with @class="media"@, and its components are named with @class="img"@ (for the image/video component) and @class="bd"@ (for the body/text component).</p>
    <p>By referencing these classes, rather than the HTML elements directly, in your stylesheets, your HTML can be flexible. For instance, if a new media element were to take off in the next few years (e.g. @<svg>@), it could be integrated into the HTML without having to touch the CSS.</p>
