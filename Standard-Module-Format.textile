...
<table>
	...
	<tr class="even">
		...
		<td>Inner exists for two reasons. First, it solves a (safari or opera?) bug in which position relative and overflow hidden cannot exist on the same element. Second, it allows for two elements on which borders can be placed to extend the number of blocks that can be built without using image based borders.</td>
	</tr>
	<tr class="odd">
	...
	<tr class="odd">
		...
		<td>The module footer is an object. <code>ft</code> provides basic sructure and it can be extended via skin classes.</td>
	</tr>
	</tbody>
</table>
</div>
