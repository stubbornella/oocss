...
I make the distinction between location-based selectors based on whether or not the sub-node is really part of the larger parent object. B and Inner clearly belong to the module, they can't exist on their own. A good rule of thumb is that anything within the body of a container is clearly a separate object.
...
This is appropriate use of the cascade:
