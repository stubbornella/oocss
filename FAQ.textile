Whoa, you have lots of questions!  Realizing I'd better start recording the answers if I want to scale better.
...
Designers are <strong>smart</strong>.  We need to give them credit. They may speak a different, non-engineering language, but often I think language is meant to create an exclusive club. 
