...
I wouldn't edit grids, template, or libraries.  A lot of testing has gone into getting those just right.  If you want to customize, think about "extending the basic objects":[[extend]] instead. That's the magic behind OOCSS.  
